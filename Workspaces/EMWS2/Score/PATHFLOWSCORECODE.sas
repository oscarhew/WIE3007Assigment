...
* NODE: MdlComp;
*------------------------------------------------------------*;
if (P_quality ge 6.83239348370927) then do;
b_quality = 1;
end;
else
if (P_quality ge 6.59648589494163) then do;
b_quality = 2;
end;
else
if (P_quality ge 6.46476317799847) then do;
b_quality = 3;
end;
else
if (P_quality ge 6.22686261107313) then do;
b_quality = 4;
end;
else
if (P_quality ge 6.10608817933658) then do;
b_quality = 5;
end;
else
if (P_quality ge 6.05194805194805) then do;
b_quality = 6;
end;
else
if (P_quality ge 5.96369047619047) then do;
b_quality = 7;
end;
else
if (P_quality ge 5.91250365176745) then do;
b_quality = 8;
end;
else
if (P_quality ge 5.86374187558031) then do;
b_quality = 9;
end;
else
if (P_quality ge 5.80851619644722) then do;
b_quality = 10;
end;
else
if (P_quality ge 5.73967561673708) then do;
b_quality = 11;
end;
else
if (P_quality ge 5.61057692307692) then do;
b_quality = 12;
end;
else
if (P_quality ge 5.5798319327731) then do;
b_quality = 13;
end;
else
if (P_quality ge 5.34907120743034) then do;
b_quality = 14;
end;
else
if (P_quality ge 5.25271501138553) then do;
b_quality = 15;
end;
else
if (P_quality ge 5.23411534701857) then do;
b_quality = 16;
end;
else
if (P_quality ge 5.17347670250896) then do;
b_quality = 17;
end;
else
if (P_quality ge 5.12992831541218) then do;
b_quality = 18;
end;
else
if (P_quality ge 5.00872093023255) then do;
b_quality = 19;
end;
else
do;
...
LABEL = 'Target Variable: quality';
EM_VALUETARGET = quality;
